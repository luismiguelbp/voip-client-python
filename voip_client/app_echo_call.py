...
class AppEchoCall(BaseVoipCall):
    """Call with mic-to-speaker echo (hear yourself) and optional recording."""
...
def run_echo_test(
    ...
    try:
        ...
        call = AppEchoCall(session.account, record_path)
...
def main() -> int:
    ...
    return run_echo_test(
        args.phone_number, args.duration, record_path, args.reg_timeout
    )
